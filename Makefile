...
#     NAME => q[Blog]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0.88], Moose=>q[0], Catalyst::Plugin::Authentication=>q[0], Catalyst::Plugin::Session=>q[0], namespace::autoclean=>q[0], Catalyst::Action::RenderView=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Digest::MD5=>q[0], Catalyst::Plugin::StackTrace=>q[0], Catalyst::Runtime=>q[5.90090], Catalyst::Helper::View::TT=>q[0], Catalyst::Plugin::Session::File=>q[0], Config::General=>q[0], Catalyst::Plugin::Session::Cookie=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Plugin::Static::Simple=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/Blog.pm]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/controller_Users.t t/model_DB.t t/view_HTML.t] }
...
PM_TO_BLIB = lib/Blog/Controller/Users.pm \
...
pure_all :: $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_cgi.pl $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_test.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_create.pl \
	  $(INST_SCRIPT)/blog_cgi.pl $(INST_SCRIPT)/blog_server.pl \
	  $(INST_SCRIPT)/blog_test.pl 
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/controller_Users.t t/model_DB.t t/view_HTML.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>ramy,,,</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Plugin::Session::Cookie" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Plugin::Session::File" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="5.9009" NAME="Catalyst::Runtime" />' >> $(DISTNAME).ppd
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::File,0,Catalyst::Plugin::Session::Cookie,0

installdeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --installdeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::File,0,Catalyst::Plugin::Session::Cookie,0

upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::File,0,Catalyst::Plugin::Session::Cookie,0,Test::More,0.88,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Digest::MD5,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::Plugin::StackTrace,0,Catalyst::Helper::View::TT,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::File,0,Catalyst::Plugin::Session::Cookie,0,Test::More,0.88,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Digest::MD5,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::Plugin::StackTrace,0,Catalyst::Helper::View::TT,0

listdeps ::
	@$(PERL) -le "print for @ARGV" Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::File Catalyst::Plugin::Session::Cookie

listalldeps ::
	@$(PERL) -le "print for @ARGV" Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::File Catalyst::Plugin::Session::Cookie Test::More Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Digest::MD5 Moose namespace::autoclean Config::General Catalyst::Plugin::StackTrace Catalyst::Helper::View::TT
